; ModuleID = '/tmp/quadratic_pascal_-c91b2e.ll'
source_filename = "/tmp/quadratic_pascal_-c91b2e.ll"
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c quadratic_pascal_.f90 -o quadratic_pascal_.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
