; ModuleID = '/tmp/do_while-d0e92d.ll'
source_filename = "/tmp/do_while-d0e92d.ll"
...
@.C331_MAIN_ = internal constant [21 x i8] c"integer//do_while.f90"
...
L.LB1_363:                                        ; preds = %L.entry
  ...
  %3 = bitcast [21 x i8]* @.C331_MAIN_ to i8*, !dbg !8
  %4 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !8
  call void (i8*, i8*, i64, ...) %4(i8* %2, i8* %3, i64 21), !dbg !8
...
L.LB1_390:                                        ; preds = %L.LB1_344
  ...
  %32 = bitcast [21 x i8]* @.C331_MAIN_ to i8*, !dbg !10
  %33 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !10
  call void (i8*, i8*, i64, ...) %33(i8* %31, i8* %32, i64 21), !dbg !10
...
L.LB1_359:                                        ; preds = %L.LB1_344
  ...
  %76 = bitcast [21 x i8]* @.C331_MAIN_ to i8*, !dbg !16
  %77 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !16
  call void (i8*, i8*, i64, ...) %77(i8* %75, i8* %76, i64 21), !dbg !16
...
L.LB1_352:                                        ; preds = %L.LB1_361, %L.LB1_359
  ...
  %102 = bitcast [21 x i8]* @.C331_MAIN_ to i8*, !dbg !17
  %103 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !17
  call void (i8*, i8*, i64, ...) %103(i8* %101, i8* %102, i64 21), !dbg !17
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c integer//do_while.f90 -o integer//do_while.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "integer/do_while.f90", directory: "/home/zou/Documents/FortranBenchmark/real")
!4 = !{}
