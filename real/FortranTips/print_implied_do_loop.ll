; ModuleID = '/tmp/print_implied_do_loop-c94004.ll'
source_filename = "/tmp/print_implied_do_loop-c94004.ll"
...
@.C354_MAIN_ = internal constant i32 4
@.C338_MAIN_ = internal constant i64 8
@.C348_MAIN_ = internal constant i32 6
@.C347_MAIN_ = internal constant [10 x i8] c"(*(1x,i0))"
@.C311_MAIN_ = internal constant i32 1
@.C350_MAIN_ = internal constant i32 14
@.C344_MAIN_ = internal constant [34 x i8] c"integer//print_implied_do_loop.f90"
...
L.LB1_386:                                        ; preds = %L.LB1_386, %L.LB1_383
  ...
  br i1 %43, label %L.LB1_386, label %L.LB1_472, !dbg !8, !llvm.loop !9

L.LB1_472:                                        ; preds = %L.LB1_386
  ...
  br i1 %49, label %L.LB1_383, label %L.LB1_473, !dbg !8, !llvm.loop !10

L.LB1_473:                                        ; preds = %L.LB1_472
  ...
  br i1 %55, label %L.LB1_380, label %L.LB1_474, !dbg !8, !llvm.loop !11

L.LB1_474:                                        ; preds = %L.LB1_473
  %56 = bitcast i32* @.C346_MAIN_ to i8*, !dbg !12
  %57 = bitcast [34 x i8]* @.C344_MAIN_ to i8*, !dbg !12
  %58 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !12
  call void (i8*, i8*, i64, ...) %58(i8* %56, i8* %57, i64 34), !dbg !12
  %59 = bitcast i32* @.C350_MAIN_ to i8*, !dbg !12
  %60 = bitcast i32* @.C311_MAIN_ to i8*, !dbg !12
  %61 = bitcast [10 x i8]* @.C347_MAIN_ to i8*, !dbg !12
  %62 = bitcast i32 (...)* @f90io_encode_fmta to i32 (i8*, i8*, i8*, i64, ...)*, !dbg !12
  %63 = call i32 (i8*, i8*, i8*, i64, ...) %62(i8* %59, i8* %60, i8* %61, i64 10), !dbg !12
  store i32 %63, i32* %z__io_351, align 4, !dbg !12
  %64 = bitcast i32* @.C348_MAIN_ to i8*, !dbg !12
  ...
  store i32 %68, i32* %z__io_351, align 4, !dbg !12
  %69 = bitcast i32* @.C355_MAIN_ to i8*, !dbg !12
  %70 = bitcast i64* @.C338_MAIN_ to i8*, !dbg !12
  %71 = bitcast i32* @.C354_MAIN_ to i8*, !dbg !12
  ...
  store i32 %74, i32* %z__io_351, align 4, !dbg !12
  %75 = call i32 (...) @f90io_fmtw_end(), !dbg !12
  store i32 %75, i32* %z__io_351, align 4, !dbg !12
  %76 = bitcast i32* @.C342_MAIN_ to i8*, !dbg !13
  %77 = bitcast [34 x i8]* @.C344_MAIN_ to i8*, !dbg !13
  %78 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !13
  call void (i8*, i8*, i64, ...) %78(i8* %76, i8* %77, i64 34), !dbg !13
  %79 = bitcast i32* @.C350_MAIN_ to i8*, !dbg !13
  %80 = bitcast i32* @.C311_MAIN_ to i8*, !dbg !13
  %81 = bitcast [10 x i8]* @.C347_MAIN_ to i8*, !dbg !13
  %82 = bitcast i32 (...)* @f90io_encode_fmta to i32 (i8*, i8*, i8*, i64, ...)*, !dbg !13
  %83 = call i32 (i8*, i8*, i8*, i64, ...) %82(i8* %79, i8* %80, i8* %81, i64 10), !dbg !13
  store i32 %83, i32* %z__io_351, align 4, !dbg !13
  %84 = bitcast i32* @.C348_MAIN_ to i8*, !dbg !13
...
L.LB1_395:                                        ; preds = %L.LB1_395, %L.LB1_392
  ...
  store i32 %107, i32* %z__io_351, align 4, !dbg !13
  ...
  br i1 %113, label %L.LB1_395, label %L.LB1_475, !dbg !13, !llvm.loop !14

L.LB1_475:                                        ; preds = %L.LB1_395
  ...
  br i1 %119, label %L.LB1_392, label %L.LB1_476, !dbg !13, !llvm.loop !15
...
L.LB1_476:                                        ; preds = %L.LB1_475
  ...
  br i1 %125, label %L.LB1_389, label %L.LB1_477, !dbg !13, !llvm.loop !16

L.LB1_477:                                        ; preds = %L.LB1_476
  %126 = call i32 (...) @f90io_fmtw_end(), !dbg !13
  store i32 %126, i32* %z__io_351, align 4, !dbg !13
  %127 = bitcast i32* @.C359_MAIN_ to i8*, !dbg !17
  %128 = bitcast [34 x i8]* @.C344_MAIN_ to i8*, !dbg !17
  %129 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !17
  call void (i8*, i8*, i64, ...) %129(i8* %127, i8* %128, i64 34), !dbg !17
  %130 = bitcast i32* @.C350_MAIN_ to i8*, !dbg !17
  %131 = bitcast i32* @.C311_MAIN_ to i8*, !dbg !17
  %132 = bitcast [10 x i8]* @.C347_MAIN_ to i8*, !dbg !17
  ...
  store i32 %134, i32* %z__io_351, align 4, !dbg !17
  %135 = bitcast i32* @.C348_MAIN_ to i8*, !dbg !17
...
L.LB1_398:                                        ; preds = %L.LB1_398, %L.LB1_477
  ...
  store i32 %165, i32* %z__io_351, align 4, !dbg !17
  ...
  br i1 %171, label %L.LB1_398, label %L.LB1_478, !dbg !17, !llvm.loop !18

L.LB1_478:                                        ; preds = %L.LB1_398
  %172 = call i32 (...) @f90io_fmtw_end(), !dbg !17
  store i32 %172, i32* %z__io_351, align 4, !dbg !17
  store i32 2, i32* %.dY0008_403, align 4, !dbg !19
  store i32 1, i32* %"i$b_363", align 4, !dbg !19
  br label %L.LB1_401

L.LB1_401:                                        ; preds = %L.LB1_401, %L.LB1_478
  ...
  br i1 %191, label %L.LB1_401, label %L.LB1_479, !dbg !19, !llvm.loop !20

L.LB1_479:                                        ; preds = %L.LB1_401
  store i64 2, i64* %.dY0009_406, align 8, !dbg !21
  store i64 1, i64* %"i$e_366", align 8, !dbg !21
  br label %L.LB1_404

L.LB1_404:                                        ; preds = %L.LB1_404, %L.LB1_479
  ...
  br i1 %209, label %L.LB1_404, label %L.LB1_480, !dbg !21, !llvm.loop !22

L.LB1_480:                                        ; preds = %L.LB1_404
  %210 = bitcast i32* @.C361_MAIN_ to i8*, !dbg !23
  %211 = bitcast [34 x i8]* @.C344_MAIN_ to i8*, !dbg !23
  %212 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !23
  call void (i8*, i8*, i64, ...) %212(i8* %210, i8* %211, i64 34), !dbg !23
  %213 = bitcast i32* @.C350_MAIN_ to i8*, !dbg !23
  %214 = bitcast i32* @.C311_MAIN_ to i8*, !dbg !23
  %215 = bitcast [10 x i8]* @.C347_MAIN_ to i8*, !dbg !23
  ...
  store i32 %217, i32* %z__io_351, align 4, !dbg !23
  %218 = bitcast i32* @.C348_MAIN_ to i8*, !dbg !23
  ...
  store i32 %222, i32* %z__io_351, align 4, !dbg !23
  store i32 2, i32* %.dY0010_409, align 4, !dbg !23
  store i32 1, i32* %i_331, align 4, !dbg !23
  br label %L.LB1_407

L.LB1_407:                                        ; preds = %L.LB1_407, %L.LB1_480
  ...
  store i32 %231, i32* %z__io_351, align 4, !dbg !23
  ...
  store i32 %240, i32* %z__io_351, align 4, !dbg !23
  ...
  br i1 %246, label %L.LB1_407, label %L.LB1_481, !dbg !23, !llvm.loop !24

L.LB1_481:                                        ; preds = %L.LB1_407
  %247 = call i32 (...) @f90io_fmtw_end(), !dbg !23
  store i32 %247, i32* %z__io_351, align 4, !dbg !23
  ret void, !dbg !25
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c integer//print_implied_do_loop.f90 -o integer//print_implied_do_loop.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "integer/print_implied_do_loop.f90", directory: "/home/zou/Documents/FortranBenchmark/real")
!4 = !{}
