; ModuleID = '/tmp/forloop_fail-57557f.ll'
source_filename = "/tmp/forloop_fail-57557f.ll"
...
@.C334_MAIN_ = internal constant [23 x i8] c"smack//forloop_fail.f90"
@.C336_MAIN_ = internal constant i32 14
...
L.LB1_352:                                        ; preds = %L.entry
  store i32 10, i32* %.dY0001_349, align 4, !dbg !8
  store i32 1, i32* %i_330, align 4, !dbg !8
  br label %L.LB1_347

L.LB1_347:                                        ; preds = %L.LB1_347, %L.LB1_352
  ...
  %8 = load i32, i32* %.dY0001_349, align 4, !dbg !10
  %9 = sub nsw i32 %8, 1, !dbg !10
  store i32 %9, i32* %.dY0001_349, align 4, !dbg !10
  %10 = load i32, i32* %.dY0001_349, align 4, !dbg !10
  %11 = icmp sgt i32 %10, 0, !dbg !10
  br i1 %11, label %L.LB1_347, label %L.LB1_367, !dbg !10, !llvm.loop !11

L.LB1_367:                                        ; preds = %L.LB1_347
  %12 = bitcast %struct.STATICS1* @.STATICS1 to i32*, !dbg !12
  %13 = load i32, i32* %12, align 4, !dbg !12
  %14 = icmp ne i32 %13, 50, !dbg !12
  br i1 %14, label %L.LB1_350, label %L.LB1_368, !dbg !12

L.LB1_368:                                        ; preds = %L.LB1_367
  %15 = bitcast i32* @.C336_MAIN_ to i8*, !dbg !12
  %16 = bitcast [23 x i8]* @.C334_MAIN_ to i8*, !dbg !12
  %17 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !12
  call void (i8*, i8*, i64, ...) %17(i8* %15, i8* %16, i64 23), !dbg !12
...
L.LB1_350:                                        ; preds = %L.LB1_368, %L.LB1_367
  ret void, !dbg !13
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//forloop_fail.f90 -o smack//forloop_fail.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/forloop_fail.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
