; ModuleID = '/tmp/compound_fail_2-789f41.ll'
source_filename = "/tmp/compound_fail_2-789f41.ll"
...
@.C336_MAIN_ = internal constant [26 x i8] c"smack//compound_fail_2.f90"
...
L.LB1_371:                                        ; preds = %L.LB1_354
  ...
  %10 = bitcast [26 x i8]* @.C336_MAIN_ to i8*, !dbg !9
  %11 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !9
  call void (i8*, i8*, i64, ...) %11(i8* %9, i8* %10, i64 26), !dbg !9
...
L.LB1_372:                                        ; preds = %L.LB1_351
  ...
  %27 = bitcast [26 x i8]* @.C336_MAIN_ to i8*, !dbg !10
  %28 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !10
  call void (i8*, i8*, i64, ...) %28(i8* %26, i8* %27, i64 26), !dbg !10
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//compound_fail_2.f90 -o smack//compound_fail_2.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/compound_fail_2.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
