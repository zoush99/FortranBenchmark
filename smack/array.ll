; ModuleID = '/tmp/array-913c21.ll'
source_filename = "/tmp/array-913c21.ll"
...
@.C331_MAIN_ = internal constant [16 x i8] c"smack//array.f90"
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//array.f90 -o smack//array.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/array.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
