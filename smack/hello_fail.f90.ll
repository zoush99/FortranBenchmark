; ModuleID = '/tmp/hello_fail-c56464.ll'
source_filename = "/tmp/hello_fail-c56464.ll"
...
@.C331_MAIN_ = internal constant [14 x i8] c"hello_fail.f90"
...
L.LB1_345:                                        ; preds = %L.entry
  br label %L.LB1_343, !dbg !8

L.LB1_355:                                        ; No predecessors!
  %2 = bitcast i32* @.C333_MAIN_ to i8*, !dbg !8
  %3 = bitcast [14 x i8]* @.C331_MAIN_ to i8*, !dbg !8
  %4 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !8
  call void (i8*, i8*, i64, ...) %4(i8* %2, i8* %3, i64 14), !dbg !8
...
L.LB1_343:                                        ; preds = %L.LB1_355, %L.LB1_345
  ret void, !dbg !9
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c hello_fail.f90 -o hello_fail.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "hello_fail.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
