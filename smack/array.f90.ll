; ModuleID = '/tmp/array-4f5117.ll'
source_filename = "/tmp/array-4f5117.ll"
...
@.C332_MAIN_ = internal constant [9 x i8] c"array.f90"
...
L.LB1_362:                                        ; preds = %L.LB1_347
  %6 = bitcast i32* @.C331_MAIN_ to i8*, !dbg !9
  %7 = bitcast [9 x i8]* @.C332_MAIN_ to i8*, !dbg !9
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c array.f90 -o array.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "array.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
