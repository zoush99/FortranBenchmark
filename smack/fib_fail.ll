; ModuleID = '/tmp/fib_fail-335fa8.ll'
source_filename = "/tmp/fib_fail-335fa8.ll"
...
@.C333_MAIN_ = internal constant [19 x i8] c"smack//fib_fail.f90"
...
L.LB2_372:                                        ; preds = %L.LB2_355
  ...
  %7 = bitcast [19 x i8]* @.C333_MAIN_ to i8*, !dbg !20
  %8 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !20
  call void (i8*, i8*, i64, ...) %8(i8* %6, i8* %7, i64 19), !dbg !20
...
L.LB2_373:                                        ; preds = %L.LB2_351
  ...
  %22 = bitcast [19 x i8]* @.C333_MAIN_ to i8*, !dbg !21
  %23 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !21
  call void (i8*, i8*, i64, ...) %23(i8* %21, i8* %22, i64 19), !dbg !21
...
L.LB2_374:                                        ; preds = %L.LB2_352
  ...
  %37 = bitcast [19 x i8]* @.C333_MAIN_ to i8*, !dbg !22
  %38 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !22
  call void (i8*, i8*, i64, ...) %38(i8* %36, i8* %37, i64 19), !dbg !22
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//fib_fail.f90 -o smack//fib_fail.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/fib_fail.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
