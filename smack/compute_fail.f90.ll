; ModuleID = '/tmp/compute_fail-3703dc.ll'
source_filename = "/tmp/compute_fail-3703dc.ll"
...
@.C335_MAIN_ = internal constant [16 x i8] c"compute_fail.f90"
...
L.LB1_365:                                        ; preds = %L.LB1_350
  ...
  %8 = bitcast [16 x i8]* @.C335_MAIN_ to i8*, !dbg !11
  %9 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !11
  call void (i8*, i8*, i64, ...) %9(i8* %7, i8* %8, i64 16), !dbg !11
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c compute_fail.f90 -o compute_fail.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "compute_fail.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
