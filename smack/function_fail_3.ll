; ModuleID = '/tmp/function_fail_3-ed168c.ll'
source_filename = "/tmp/function_fail_3-ed168c.ll"
...
@.C333_MAIN_ = internal constant [26 x i8] c"smack//function_fail_3.f90"
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//function_fail_3.f90 -o smack//function_fail_3.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/function_fail_3.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
