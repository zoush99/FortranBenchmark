; ModuleID = '/tmp/array-70c1ec.ll'
source_filename = "/tmp/array-70c1ec.ll"
...
@.C331_MAIN_ = internal constant [9 x i8] c"array.f90"
...
L.LB1_363:                                        ; preds = %L.LB1_347
  ...
  %7 = bitcast [9 x i8]* @.C331_MAIN_ to i8*, !dbg !9
  %8 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !9
  call void (i8*, i8*, i64, ...) %8(i8* %6, i8* %7, i64 9), !dbg !9
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c array.f90 -o test.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "array.f90", directory: "/home/zou/Documents/Fortran95/smack")
!4 = !{}
