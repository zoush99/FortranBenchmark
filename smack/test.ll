; ModuleID = '/tmp/pointer_fail-cd8319.ll'
source_filename = "/tmp/pointer_fail-cd8319.ll"
...
L.LB1_371:                                        ; preds = %L.LB1_357
  ...
  %14 = bitcast [16 x i8]* @.C335_MAIN_ to i8*, !dbg !14
  %15 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !14
  call void (i8*, i8*, i64, ...) %15(i8* %13, i8* %14, i64 16), !dbg !14
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c pointer_fail.f90 -o test.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
