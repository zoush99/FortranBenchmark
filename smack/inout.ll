; ModuleID = '/tmp/inout-8ad967.ll'
source_filename = "/tmp/inout-8ad967.ll"
...
@.C333_MAIN_ = internal constant [16 x i8] c"smack//inout.f90"
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//inout.f90 -o smack//inout.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/inout.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
