; ModuleID = '/tmp/fib_fail_2-2d6f54.ll'
source_filename = "/tmp/fib_fail_2-2d6f54.ll"
...
@.C347_MAIN_ = internal constant i32 32
@.C346_MAIN_ = internal constant i32 8
@.C345_MAIN_ = internal constant i32 31
...
@.C333_MAIN_ = internal constant [21 x i8] c"smack//fib_fail_2.f90"
...
L.LB2_355:                                        ; preds = %L.entry
  ...
  br i1 %5, label %L.LB2_351, label %L.LB2_372, !dbg !20

L.LB2_372:                                        ; preds = %L.LB2_355
  %6 = bitcast i32* @.C335_MAIN_ to i8*, !dbg !20
  %7 = bitcast [21 x i8]* @.C333_MAIN_ to i8*, !dbg !20
  %8 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !20
  call void (i8*, i8*, i64, ...) %8(i8* %6, i8* %7, i64 21), !dbg !20
...
L.LB2_351:                                        ; preds = %L.LB2_372, %L.LB2_355
  %18 = bitcast i32* @.C344_MAIN_ to i64*, !dbg !21
  %19 = call i32 @fib_(i64* %18), !dbg !21
  %20 = icmp eq i32 %19, 5, !dbg !21
  br i1 %20, label %L.LB2_352, label %L.LB2_373, !dbg !21

L.LB2_373:                                        ; preds = %L.LB2_351
  %21 = bitcast i32* @.C345_MAIN_ to i8*, !dbg !21
  %22 = bitcast [21 x i8]* @.C333_MAIN_ to i8*, !dbg !21
  %23 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !21
  call void (i8*, i8*, i64, ...) %23(i8* %21, i8* %22, i64 21), !dbg !21
...
L.LB2_352:                                        ; preds = %L.LB2_373, %L.LB2_351
  %33 = bitcast i32* @.C336_MAIN_ to i64*, !dbg !22
  %34 = call i32 @fib_(i64* %33), !dbg !22
  %35 = icmp ne i32 %34, 8, !dbg !22
  br i1 %35, label %L.LB2_353, label %L.LB2_374, !dbg !22

L.LB2_374:                                        ; preds = %L.LB2_352
  %36 = bitcast i32* @.C347_MAIN_ to i8*, !dbg !22
  %37 = bitcast [21 x i8]* @.C333_MAIN_ to i8*, !dbg !22
  %38 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !22
  call void (i8*, i8*, i64, ...) %38(i8* %36, i8* %37, i64 21), !dbg !22
...
L.LB2_353:                                        ; preds = %L.LB2_374, %L.LB2_352
  ret void, !dbg !23
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//fib_fail_2.f90 -o smack//fib_fail_2.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/fib_fail_2.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
...
!20 = !DILocation(line: 30, column: 1, scope: !16)
!21 = !DILocation(line: 31, column: 1, scope: !16)
!22 = !DILocation(line: 32, column: 1, scope: !16)
!23 = !DILocation(line: 33, column: 1, scope: !16)
