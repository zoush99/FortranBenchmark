; ModuleID = '/tmp/compound-7f6ab7.ll'
source_filename = "/tmp/compound-7f6ab7.ll"
...
@.C347_MAIN_ = internal constant i32 16
...
@.C336_MAIN_ = internal constant [12 x i8] c"compound.f90"
@.C338_MAIN_ = internal constant i32 15
...
L.LB1_354:                                        ; preds = %L.entry
  ...
  %8 = icmp eq i32 %7, 2, !dbg !9
  br i1 %8, label %L.LB1_351, label %L.LB1_369, !dbg !9

L.LB1_369:                                        ; preds = %L.LB1_354
  %9 = bitcast i32* @.C338_MAIN_ to i8*, !dbg !9
  %10 = bitcast [12 x i8]* @.C336_MAIN_ to i8*, !dbg !9
  %11 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !9
  call void (i8*, i8*, i64, ...) %11(i8* %9, i8* %10, i64 12), !dbg !9
...
L.LB1_351:                                        ; preds = %L.LB1_369, %L.LB1_354
  ...
  %25 = icmp eq i32 %24, 3, !dbg !10
  br i1 %25, label %L.LB1_352, label %L.LB1_370, !dbg !10

L.LB1_370:                                        ; preds = %L.LB1_351
  %26 = bitcast i32* @.C347_MAIN_ to i8*, !dbg !10
  %27 = bitcast [12 x i8]* @.C336_MAIN_ to i8*, !dbg !10
  %28 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !10
  call void (i8*, i8*, i64, ...) %28(i8* %26, i8* %27, i64 12), !dbg !10
...
L.LB1_352:                                        ; preds = %L.LB1_370, %L.LB1_351
  ret void, !dbg !11
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c compound.f90 -o compound.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "compound.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
...
!9 = !DILocation(line: 15, column: 1, scope: !5)
!10 = !DILocation(line: 16, column: 1, scope: !5)
!11 = !DILocation(line: 17, column: 1, scope: !5)
