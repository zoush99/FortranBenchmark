; ModuleID = '/tmp/hello_fail-e011f9.ll'
source_filename = "/tmp/hello_fail-e011f9.ll"
...
@.C333_MAIN_ = internal constant [21 x i8] c"smack//hello_fail.f90"
...
L.LB1_350:                                        ; preds = %L.entry
  ...
  %2 = load i32, i32* %b_330, align 4, !dbg !10
...
L.LB1_364:                                        ; preds = %L.LB1_350
  ...
  %6 = bitcast [21 x i8]* @.C333_MAIN_ to i8*, !dbg !10
  %7 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !10
  call void (i8*, i8*, i64, ...) %7(i8* %5, i8* %6, i64 21), !dbg !10
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//hello_fail.f90 -o smack//hello_fail.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/hello_fail.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
