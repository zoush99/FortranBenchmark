; ModuleID = '/tmp/array_fail-4d8664.ll'
source_filename = "/tmp/array_fail-4d8664.ll"
...
@.C335_MAIN_ = internal constant [12 x i8] c"assert error"
@.C310_MAIN_ = internal constant i64 0
@.C334_MAIN_ = internal constant i32 6
@.C331_MAIN_ = internal constant [21 x i8] c"smack//array_fail.f90"
@.C333_MAIN_ = internal constant i32 10
...
L.LB1_347:                                        ; preds = %L.entry
  ...
  br i1 %5, label %L.LB1_345, label %L.LB1_363, !dbg !9

L.LB1_363:                                        ; preds = %L.LB1_347
  %6 = bitcast i32* @.C333_MAIN_ to i8*, !dbg !9
  %7 = bitcast [21 x i8]* @.C331_MAIN_ to i8*, !dbg !9
  %8 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !9
  call void (i8*, i8*, i64, ...) %8(i8* %6, i8* %7, i64 21), !dbg !9
  %9 = bitcast i32* @.C334_MAIN_ to i8*, !dbg !9
  ...
  store i32 %13, i32* %z__io_337, align 4, !dbg !9
  %14 = bitcast [12 x i8]* @.C335_MAIN_ to i8*, !dbg !9
  ...
  store i32 %17, i32* %z__io_337, align 4, !dbg !9
  br label %L.LB1_345

L.LB1_345:                                        ; preds = %L.LB1_363, %L.LB1_347
  ret void, !dbg !10
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//array_fail.f90 -o smack//array_fail.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/array_fail.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
