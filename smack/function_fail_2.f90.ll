; ModuleID = '/tmp/function_fail_2-666fdb.ll'
source_filename = "/tmp/function_fail_2-666fdb.ll"
...
@.C347_MAIN_ = internal constant i32 28
...
@.C333_MAIN_ = internal constant [19 x i8] c"function_fail_2.f90"
...
L.LB2_373:                                        ; preds = %L.LB2_355
  ...
  %6 = bitcast [19 x i8]* @.C333_MAIN_ to i8*, !dbg !17
  %7 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !17
  call void (i8*, i8*, i64, ...) %7(i8* %5, i8* %6, i64 19), !dbg !17
...
L.LB2_374:                                        ; preds = %L.LB2_351
  ...
  %21 = bitcast [19 x i8]* @.C333_MAIN_ to i8*, !dbg !18
  %22 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !18
  call void (i8*, i8*, i64, ...) %22(i8* %20, i8* %21, i64 19), !dbg !18
...
L.LB2_375:                                        ; preds = %L.LB2_352
  ...
  %38 = bitcast [19 x i8]* @.C333_MAIN_ to i8*, !dbg !20
  %39 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !20
  call void (i8*, i8*, i64, ...) %39(i8* %37, i8* %38, i64 19), !dbg !20
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c function_fail_2.f90 -o function_fail_2.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "function_fail_2.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
...
!19 = !DILocation(line: 26, column: 1, scope: !14)
!20 = !DILocation(line: 28, column: 1, scope: !14)
!21 = !DILocation(line: 29, column: 1, scope: !14)
