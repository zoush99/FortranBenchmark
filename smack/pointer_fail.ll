; ModuleID = '/tmp/pointer_fail-a9abd1.ll'
source_filename = "/tmp/pointer_fail-a9abd1.ll"
...
@.C335_MAIN_ = internal constant [23 x i8] c"smack//pointer_fail.f90"
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//pointer_fail.f90 -o smack//pointer_fail.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/pointer_fail.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
