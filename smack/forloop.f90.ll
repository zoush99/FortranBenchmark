; ModuleID = '/tmp/forloop-ed2dd7.ll'
source_filename = "/tmp/forloop-ed2dd7.ll"
...
@.C334_MAIN_ = internal constant [11 x i8] c"forloop.f90"
...
L.LB1_368:                                        ; preds = %L.LB1_367
  ...
  %16 = bitcast [11 x i8]* @.C334_MAIN_ to i8*, !dbg !12
  %17 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !12
  call void (i8*, i8*, i64, ...) %17(i8* %15, i8* %16, i64 11), !dbg !12
...
!3 = !DIFile(filename: "forloop.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
