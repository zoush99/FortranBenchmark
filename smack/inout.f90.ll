; ModuleID = '/tmp/inout-02ce7b.ll'
source_filename = "/tmp/inout-02ce7b.ll"
...
@.C332_MAIN_ = internal constant [9 x i8] c"inout.f90"
@.C334_MAIN_ = internal constant i32 15
...
L.LB2_348:                                        ; preds = %L.entry
  ...
  br i1 %5, label %L.LB2_346, label %L.LB2_361, !dbg !15

L.LB2_361:                                        ; preds = %L.LB2_348
  %6 = bitcast i32* @.C334_MAIN_ to i8*, !dbg !15
  %7 = bitcast [9 x i8]* @.C332_MAIN_ to i8*, !dbg !15
  %8 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !15
  call void (i8*, i8*, i64, ...) %8(i8* %6, i8* %7, i64 9), !dbg !15
  %9 = bitcast i32* @.C335_MAIN_ to i8*, !dbg !15
  ...
  store i32 %13, i32* %z__io_338, align 4, !dbg !15
  %14 = bitcast [12 x i8]* @.C336_MAIN_ to i8*, !dbg !15
  %15 = bitcast i32 (...)* @f90io_sc_ch_ldw to i32 (i8*, i32, i64, ...)*, !dbg !15
  %16 = call i32 (i8*, i32, i64, ...) %15(i8* %14, i32 14, i64 12), !dbg !15
  store i32 %16, i32* %z__io_338, align 4, !dbg !15
  %17 = call i32 (...) @f90io_ldw_end(), !dbg !15
  store i32 %17, i32* %z__io_338, align 4, !dbg !15
  br label %L.LB2_346

L.LB2_346:                                        ; preds = %L.LB2_361, %L.LB2_348
  ret void, !dbg !16
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c inout.f90 -o inout.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "inout.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
