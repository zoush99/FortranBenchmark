; ModuleID = '/tmp/function_fail-6eabde.ll'
source_filename = "/tmp/function_fail-6eabde.ll"
...
@.C333_MAIN_ = internal constant [24 x i8] c"smack//function_fail.f90"
...
L.LB2_374:                                        ; preds = %L.LB2_351
  ...
  %21 = bitcast [24 x i8]* @.C333_MAIN_ to i8*, !dbg !18
  %22 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !18
  call void (i8*, i8*, i64, ...) %22(i8* %20, i8* %21, i64 24), !dbg !18
...
L.LB2_375:                                        ; preds = %L.LB2_352
  ...
  %38 = bitcast [24 x i8]* @.C333_MAIN_ to i8*, !dbg !20
  %39 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !20
  call void (i8*, i8*, i64, ...) %39(i8* %37, i8* %38, i64 24), !dbg !20
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//function_fail.f90 -o smack//function_fail.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/function_fail.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
...
!16 = !{null}
!17 = !DILocation(line: 29, column: 1, scope: !14)
!18 = !DILocation(line: 30, column: 1, scope: !14)
!19 = !DILocation(line: 32, column: 1, scope: !14)
!20 = !DILocation(line: 34, column: 1, scope: !14)
!21 = !DILocation(line: 36, column: 1, scope: !14)
