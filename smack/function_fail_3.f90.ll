; ModuleID = '/tmp/function_fail_3-1c5632.ll'
source_filename = "/tmp/function_fail_3-1c5632.ll"
...
@.C333_MAIN_ = internal constant [19 x i8] c"function_fail_3.f90"
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c function_fail_3.f90 -o function_fail_3.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "function_fail_3.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
...
!21 = !DILocation(line: 30, column: 1, scope: !14)
