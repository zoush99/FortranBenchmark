; ModuleID = '/tmp/fib_fail_2-eef069.ll'
source_filename = "/tmp/fib_fail_2-eef069.ll"
...
@.C334_MAIN_ = internal constant [14 x i8] c"fib_fail_2.f90"
@.C336_MAIN_ = internal constant i32 28
...
L.LB2_355:                                        ; preds = %L.entry
  ...
  br i1 %5, label %L.LB2_351, label %L.LB2_371, !dbg !20

L.LB2_371:                                        ; preds = %L.LB2_355
  %6 = bitcast i32* @.C336_MAIN_ to i8*, !dbg !20
  %7 = bitcast [14 x i8]* @.C334_MAIN_ to i8*, !dbg !20
  %8 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !20
  call void (i8*, i8*, i64, ...) %8(i8* %6, i8* %7, i64 14), !dbg !20
  %9 = bitcast i32* @.C337_MAIN_ to i8*, !dbg !20
  ...
  store i32 %13, i32* %z__io_340, align 4, !dbg !20
  %14 = bitcast [12 x i8]* @.C338_MAIN_ to i8*, !dbg !20
  %15 = bitcast i32 (...)* @f90io_sc_ch_ldw to i32 (i8*, i32, i64, ...)*, !dbg !20
  %16 = call i32 (i8*, i32, i64, ...) %15(i8* %14, i32 14, i64 12), !dbg !20
  store i32 %16, i32* %z__io_340, align 4, !dbg !20
...
L.LB2_351:                                        ; preds = %L.LB2_371, %L.LB2_355
  ...
  %20 = icmp eq i32 %19, 5, !dbg !21
  br i1 %20, label %L.LB2_352, label %L.LB2_372, !dbg !21

L.LB2_372:                                        ; preds = %L.LB2_351
  %21 = bitcast i32* @.C345_MAIN_ to i8*, !dbg !21
  %22 = bitcast [14 x i8]* @.C334_MAIN_ to i8*, !dbg !21
  %23 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !21
  call void (i8*, i8*, i64, ...) %23(i8* %21, i8* %22, i64 14), !dbg !21
  %24 = bitcast i32* @.C337_MAIN_ to i8*, !dbg !21
...
L.LB2_373:                                        ; preds = %L.LB2_352
  ...
  store i32 %43, i32* %z__io_340, align 4, !dbg !22
  %44 = bitcast [12 x i8]* @.C338_MAIN_ to i8*, !dbg !22
  %45 = bitcast i32 (...)* @f90io_sc_ch_ldw to i32 (i8*, i32, i64, ...)*, !dbg !22
  %46 = call i32 (i8*, i32, i64, ...) %45(i8* %44, i32 14, i64 12), !dbg !22
  store i32 %46, i32* %z__io_340, align 4, !dbg !22
  %47 = call i32 (...) @f90io_ldw_end(), !dbg !22
  store i32 %47, i32* %z__io_340, align 4, !dbg !22
  br label %L.LB2_353
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c fib_fail_2.f90 -o fib_fail_2.f90.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "fib_fail_2.f90", directory: "/home/zou/Documents/f-ikos/benchmark/FortranProByzou/f-ikos/smack")
!4 = !{}
