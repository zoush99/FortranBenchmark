; ModuleID = '/tmp/function_fail_2-ad4201.ll'
source_filename = "/tmp/function_fail_2-ad4201.ll"
...
@.STATICS2 = internal global %struct.STATICS2 <{ [4 x i8] c"\08\00\00\00" }>, align 16
@.C347_MAIN_ = internal constant i32 34
@.C346_MAIN_ = internal constant i32 31
...
@.C333_MAIN_ = internal constant [26 x i8] c"smack//function_fail_2.f90"
@.C335_MAIN_ = internal constant i32 30
...
L.LB2_355:                                        ; preds = %L.entry
  ...
  br i1 %4, label %L.LB2_351, label %L.LB2_373, !dbg !17

L.LB2_373:                                        ; preds = %L.LB2_355
  %5 = bitcast i32* @.C335_MAIN_ to i8*, !dbg !17
  %6 = bitcast [26 x i8]* @.C333_MAIN_ to i8*, !dbg !17
  %7 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !17
  call void (i8*, i8*, i64, ...) %7(i8* %5, i8* %6, i64 26), !dbg !17
...
L.LB2_351:                                        ; preds = %L.LB2_373, %L.LB2_355
  %17 = bitcast i32* @.C344_MAIN_ to i64*, !dbg !18
  %18 = call i32 @cap_(i64* %17), !dbg !18
  %19 = icmp ne i32 %18, 10, !dbg !18
  br i1 %19, label %L.LB2_352, label %L.LB2_374, !dbg !18

L.LB2_374:                                        ; preds = %L.LB2_351
  %20 = bitcast i32* @.C346_MAIN_ to i8*, !dbg !18
  %21 = bitcast [26 x i8]* @.C333_MAIN_ to i8*, !dbg !18
  %22 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !18
  call void (i8*, i8*, i64, ...) %22(i8* %20, i8* %21, i64 26), !dbg !18
...
L.LB2_352:                                        ; preds = %L.LB2_374, %L.LB2_351
  %32 = bitcast %struct.STATICS2* @.STATICS2 to i32*, !dbg !19
  %33 = load i32, i32* %32, align 4, !dbg !19
  store i32 %33, i32* %x_330, align 4, !dbg !19
  %34 = bitcast i32* %x_330 to i64*, !dbg !20
  %35 = call i32 @cap_(i64* %34), !dbg !20
  %36 = icmp sle i32 %35, 10, !dbg !20
  br i1 %36, label %L.LB2_353, label %L.LB2_375, !dbg !20

L.LB2_375:                                        ; preds = %L.LB2_352
  %37 = bitcast i32* @.C347_MAIN_ to i8*, !dbg !20
  %38 = bitcast [26 x i8]* @.C333_MAIN_ to i8*, !dbg !20
  %39 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !20
  call void (i8*, i8*, i64, ...) %39(i8* %37, i8* %38, i64 26), !dbg !20
  %40 = bitcast i32* @.C336_MAIN_ to i8*, !dbg !20
  %41 = bitcast i32* @.C309_MAIN_ to i8*, !dbg !20
  %42 = bitcast i32* @.C309_MAIN_ to i8*, !dbg !20
  %43 = bitcast i32 (...)* @f90io_print_init to i32 (i8*, i8*, i8*, i8*, ...)*, !dbg !20
  %44 = call i32 (i8*, i8*, i8*, i8*, ...) %43(i8* %40, i8* null, i8* %41, i8* %42), !dbg !20
  store i32 %44, i32* %z__io_339, align 4, !dbg !20
  %45 = bitcast [12 x i8]* @.C337_MAIN_ to i8*, !dbg !20
  %46 = bitcast i32 (...)* @f90io_sc_ch_ldw to i32 (i8*, i32, i64, ...)*, !dbg !20
  %47 = call i32 (i8*, i32, i64, ...) %46(i8* %45, i32 14, i64 12), !dbg !20
  store i32 %47, i32* %z__io_339, align 4, !dbg !20
  %48 = call i32 (...) @f90io_ldw_end(), !dbg !20
  store i32 %48, i32* %z__io_339, align 4, !dbg !20
  br label %L.LB2_353

L.LB2_353:                                        ; preds = %L.LB2_375, %L.LB2_352
  ret void, !dbg !21
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c smack//function_fail_2.f90 -o smack//function_fail_2.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "smack/function_fail_2.f90", directory: "/home/zou/Documents/Fortran95")
!4 = !{}
...
!16 = !{null}
!17 = !DILocation(line: 30, column: 1, scope: !14)
!18 = !DILocation(line: 31, column: 1, scope: !14)
!19 = !DILocation(line: 32, column: 1, scope: !14)
!20 = !DILocation(line: 34, column: 1, scope: !14)
!21 = !DILocation(line: 35, column: 1, scope: !14)
